...
/*  Handles sort list items   */
export class UpdateListFromSorting_Transaction extends jsTPS_Transaction {
    constructor(_id, originalList, callback, undoCallback) {
        super();
        this._id = _id;
    ...
    async undoTransaction() {
        const { data } = await this.undoUpdateFunction({ variables: { _id: this._id, originalList: this.originalList }});
		return data;
    }
}
