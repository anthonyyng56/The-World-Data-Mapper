...
export const SORT_BY_TASK = gql`
	mutation SortByTask($_id: String!) {
		sortByTask(_id: $_id) {
			_id
		}
	}
...
export const SORT_BY_DATE = gql`
	mutation SortByDate($_id: String!) {
		sortByDate(_id: $_id) {
			_id
		}
	}
...
export const SORT_BY_COMPLETED = gql`
	mutation SortByCompleted($_id: String!) {
		sortByCompleted(_id: $_id) {
			_id
		}
	}
`;

export const SORT_BY_ASSIGNED_TO = gql`
	mutation SortByAssignedTo($_id: String!) {
		sortByAssignedTo(_id: $_id) {
			_id
		}
	}
`;

export const UNDO_SORT_ITEMS = gql`
	mutation UndoSortItems($_id: String!, $originalList: [ItemInput]!) {
		undoSortItems(_id: $_id, originalList: $originalList) {
			_id
		}
	}
`;
